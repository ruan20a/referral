...
Job.create(name: "Hukkster", job_name: "Operations Associate", description: "This is the Job", speciality_1: "Operations", speciality_2: "Administrative", city: "New York", state: "NY", referral_fee: 1500 )
