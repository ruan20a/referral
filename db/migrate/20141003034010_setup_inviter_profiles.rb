class SetupInviterProfiles < ActiveRecord::Migration
  def change
    create_table :inviter_profiles do |t|
      ...
      t.integer :users_generated, :default => 0 #number of created users
      t.integer :referrals_generated, :default => 0 #number of created job referrals
      t.timestamps
    end
    ...
    add_index :referrals, :invited_by_ipf_id
